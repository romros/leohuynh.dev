...
**Tech Lead | IT Project & Process Manager | Full Stack Developer | Senior Software Engineer**
...
- **Process Leader** (2020 - 2023)

  - Technological process optimization integrating OKR and KPI.
  ...
  - Highlighted Projects: Implementation of an agile organization system.
...
- **Frontend Development**: Proficiency in Reactjs, nextjs, tailwindcss, github, API development, HTML5, CSS, Bootstrap, AngularJS, jQuery and jQueryMobile.
- **Backend Development**: Strong experience with python, nodejs, php, mysql, postgresql, docker, and other backend technologies.
